...
2. Deploy application to Kubernetes
   ...
   Before you deploy application to Kubernetes you need to modify the `./kubernetes/application.yaml` file. Replace code below with  the   image you just pushed to GCR.
